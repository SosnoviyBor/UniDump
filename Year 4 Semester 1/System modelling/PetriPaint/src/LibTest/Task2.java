...
public class Task2 {
    ...
    public static PetriObjModel getModel() throws
        ...
        list.add(new PetriSim(doMove(6)));                              // робот1
        list.add(new PetriSim(doProcess(60, "norm")));        // верстат1
        list.add(new PetriSim(doMove(7)));                              // робот2
        list.add(new PetriSim(doProcess(100, "exp")));        // верстат2
        list.add(new PetriSim(doMove(5)));                              // робот3
    ...
    private static PetriNet doProcess(double timeMean, String distribution)
            throws ExceptionInvalidTimeDelay {
        ArrayList<PetriP> places = new ArrayList<>();
        ArrayList<PetriT> transitions = new ArrayList<>();
        ArrayList<ArcIn> arcIns = new ArrayList<>();
