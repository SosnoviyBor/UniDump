...
public class Task3 {
    ...
    public static PetriObjModel getModel() throws
        ...
        list.add(new PetriSim(netGenerator()));
        list.add(new PetriSim(netGenerator()));
        list.add(new PetriSim(busModel(1, 20.0)));
        list.add(new PetriSim(busModel(1, 30.0)));
        list.add(new PetriSim(busModel(0, 20.0)));
        list.add(new PetriSim(busModel(0, 30.0)));
