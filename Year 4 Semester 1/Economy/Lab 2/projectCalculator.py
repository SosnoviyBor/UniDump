...
if __name__ == "__main__":
    ...
    Project("2048", 4000, AVERAGE_JUNIOR_SALARY).results()
    Project("calculator", 70_254, AVERAGE_JUNIOR_SALARY).results()
    Project("pandas", 398_087, AVERAGE_JUNIOR_SALARY).results()
