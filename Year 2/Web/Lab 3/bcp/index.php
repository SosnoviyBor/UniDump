	...
	<body>
		<div class="wrapper">
			...
			<main id="four">
				...
				<!-- Imagine, multiple <selection> here -->
				<?php
...
<!--		CAROUSEL CODE EXAMPLE
	<section class="carousel" aria-label="Gallery">
		<ol class="c_viewport">
			<li id="c_slide1" tabindex="0" class="c_slide">
				<a class="s_text">some text 1</a>
				<div class="c_snapper"></div>
				<a href="#c_slide3" class="c_prev"></a>
				<a href="#c_slide2" class="c_next"></a>
			</li>
			<li id="c_slide2" tabindex="0" class="c_slide">
				<a class="s_text">some text 2</a>
				<div class="c_snapper"></div>
				<a href="#c_slide1" class="c_prev"></a>
				<a href="#c_slide3" class="c_next"></a>
			</li>
			<li id="c_slide3" tabindex="0" class="c_slide">
				<a class="s_text">some text 3</a>
				<div class="c_snapper"></div>
				<a href="#c_slide2" class="c_prev"></a>
				<a href="#c_slide1" class="c_next"></a>
			</li>
		</ol>
	</section>
-->